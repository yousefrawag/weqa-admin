...
const createEmployess = new mongoose.Schema(
  {
    username: {
      type: String,
    ...
    grander: {
      type: String,
      enum: ["male", "female"],
      required: [true, "Required Grander User"],
    },
    identity: {
      type: Number,
    ...
    role: {
      ...
      required: [true, "Required role User"],
    },
  },
  { timestamps: true }
);

const createEmployessModel = mongoose.model("employee", createEmployess);
module.exports = createEmployessModel;
